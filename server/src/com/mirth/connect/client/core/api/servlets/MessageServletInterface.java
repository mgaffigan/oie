...
public interface MessageServletInterface extends BaseServletInterface {
    ...
    public void removeMessage(// @formatter:off
    		...
    		@Param("patientId") @Parameter(description = "The patient ID of the channel message.", required = false) @QueryParam("patientId") String patientId) throws ClientException;
    // @formatter:on
