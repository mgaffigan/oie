...
const ImportTrustedCertificateDialog = forwardRef(function ImportTrustedCertificateDialog({
  ...
  const isImportDisabled = () => {
    ...
    if (errors.pemText || errors.alias || errors.file) {
      return true
    }
...
export default ImportTrustedCertificateDialog
